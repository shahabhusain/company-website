...
const Challenge = () => {
  return (
    <div className=" md:mx-44 mx-4 pt-32">
      <h1 className=" text-[#1D67D5] md:text-[32px] text-[22px] font-bold">
      ...
      <div className=" md:flex block justify-between">
        <div className=" flex flex-col gap-5 pt-4 ">
          <div className=" flex gap-4">
            <h1 className=" text-[#1D67D5] text-[20px] font-medium">1</h1>
            <div>
              <h2 className=" text-[#1D67D5] text-[20px] font-medium">
          ...
          <div className=" flex gap-4">
            <h1 className=" text-[#1D67D5] text-[20px] font-medium">2</h1>
            <div>
              <h2 className=" text-[#1D67D5] text-[20px] font-medium">
          ...
          <div className=" flex gap-4">
            <h1 className=" text-[#1D67D5] text-[20px] font-medium">3</h1>
            <div>
              <h2 className=" text-[#1D67D5] text-[20px] font-medium">
