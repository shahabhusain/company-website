...
const Technology = () => {
  return (
    <div className=' md:mx-44 mx-4 flex flex-col gap-4 pt-14'>
        <h1 className=' text-[#0C97BD] md:text-[37px] sm:text-[37px] text-[27px] font-bold'>Technology <span className=' text-black md:text-[47px] sm:text-[37px] text-[27px] font-normal'>Used</span></h1>
        <p className=' md:text-[17px] text-[12px] text-[#606060] font-normal'>For the development central project, several technologies are used to create a seamless and robust experience for users.</p>
        <div className=' grid md:grid-cols-5 sm:grid-cols-2 grid-cols-1 md:pt-16 gap-4 md:mx-0 mx-auto '>
            ...
            <div className=' flex flex-col items-center justify-center gap-3'>
                <img src={side3} alt="" />
                <h1 className=' text-[#22222A] md:text-[22px] text-[15px] font-[600] whitespace-nowrap '>Google Maps API </h1>
